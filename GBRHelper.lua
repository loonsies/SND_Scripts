...
do_extract  = false                                      --If true, will extract materia if possible

do_reduce   = true                                      --If true, will perform aetherial reduction if possible.
reduce_gp_threshold = 1--Will prefer reducing if gp is lower than that value to optimize low-gp time
reduce_free_slot = 10--Inventory slots left before forcing aetherial reduction
