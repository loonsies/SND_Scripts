...
--[[ 
    ...
    **************
	...
	LeveQuestNumber = 1640
		-- 1638 = Northern Sea Salt : Salt of the North
		-- 1639 = Zurek : Topping Up the Pot
		-- 1640 = Island Miq'abob : Bobbing for Compliments
		-- 1641 = Borscht : At Any Temperature
		-- 1642 = Glory Be Soup : Imperial Palate
		-- 1643 = Carrot Nibbles : A Stickler for Carrots
		-- 1644 = Skyr : A Historical Flavor
		-- 1645 = Yakow Moussaka : Comfort Food
		-- 1646 = The Noodles of Elpis : Blast from the Pasta
...
--[[
    ...
    ************
	...
	if LeveQuestNumber == 1638 then
		itemID = 36078
		LeveDetail = 1638
	elseif LeveQuestNumber == 1639 then
		itemID = 36037
		LeveDetail = 1639
	elseif LeveQuestNumber == 1640 then
		itemID = 36040
		LeveDetail = 1640
	elseif LeveQuestNumber == 1641 then
		itemID = 36043
		LeveDetail = 1641
	elseif LeveQuestNumber == 1642 then
		itemID = 36045
		LeveDetail = 1642
	elseif LeveQuestNumber == 1643 then
		itemID = 36052
		LeveDetail = 1643
	elseif LeveQuestNumber == 1644 then
		itemID = 36040
		LeveDetail = 1644
	elseif LeveQuestNumber == 1645 then 
		itemID = 36054
		LeveDetail = 1645
	elseif LeveQuestNumber == 1646 then
		itemID = 36058
		LeveDetail = 1646
	elseif LeveQuestNumber == 1647 then 
		itemID = 36060 
		LeveDetail = 1647
	else
